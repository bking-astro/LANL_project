...
fp=loadfile('/global/cscratch1/sd/bkingast/LANL_project/pycbc_runs/data/cs5_inj20_0130_ind.hdf','r+')
...
fp=loadfile('/global/cscratch1/sd/bkingast/LANL_project/pycbc_runs/data/uniform_inj20_0130_ind.hdf','r+')
...
plt.tight_layout()
plt.savefig("../plots/lambda_prior_post_inj20.png")
