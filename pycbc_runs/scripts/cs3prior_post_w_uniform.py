...
ax.hist(samples_prior_rec2nsat['lambda_tilde'], bins=40, histtype='step',
        facecolor='None', edgecolor='g', ls='dotted', lw=2, density=True, label=r"Prior:cs3")
ax.hist(samples_post_rec2nsat['lambda_tilde'], bins=num_bins, histtype='step',
        facecolor='None', edgecolor='g', ls='solid', lw=2,
        density=True, label=r"Posterior:cs3 prior")
#ax.set(xlabel=l)
#         density=True, label=r"Posterior: Uniform $\tilde \Lambda$ prior")
...
plt.title('Comparison of cs3 and Uniform', fontsize=18, pad=18)
plt.tight_layout()
plt.savefig("../plots/cs3_lambda_prior_post.png")
...
plt.tight_layout()
plt.savefig("../plots/cs3_r1p4_prior_post.png")
