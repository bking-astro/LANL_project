...
fp=loadfile('/global/cscratch1/sd/bkingast/LANL_project/pycbc_runs/data/cs5n0_0829_ind.hdf','r+')
...
ax.hist(samples_prior_uniform['lambda_tilde'], bins=40, histtype='step',
        facecolor='None', edgecolor='b', ls='dotted', lw=2, density=True, label=r"Prior: cs5_n0")
ax.hist(samples_post_uniform['lambda_tilde'], bins=num_bins, histtype='step',
        facecolor='None', edgecolor='b', ls='solid', lw=2,
        density=True, label=r"Posterior: cs5_n0 prior") 
...
plt.title('Comparison of cs5 and cs5_n0', fontsize=18, pad=18)
plt.tight_layout()
plt.savefig("../plots/lambda_cs5_cs5n0.png")
...
plt.title('Comparison of cs5 and cs5_n0', fontsize=18, pad=18)
plt.tight_layout()
plt.savefig("../plots/r1p4_cs5_cs5_n0.png")
